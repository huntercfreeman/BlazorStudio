...
{
    [CascadingParameter(Name="SetShouldDisplayContextMenuAsync")]
    public Func<bool, Task> SetShouldDisplayContextMenuAsync { get; set; } = null!;
    ...
    private async Task HandleOnKeyDownAsync(KeyboardEventArgs keyboardEventArgs)
    {
        ...
        {
            await SetShouldDisplayContextMenuAsync.Invoke(false);
        }
    }
