...
public class MEMORY_MAPPED_FILE_TESTS : PLAIN_TEXT_EDITOR_STATES_TESTS
{
    ...
    {
        string path = @$"./TestData/{nameof(GET_FILE_ENCODING_UTF8)}.txt";
    ...
    [Fact]
    public static void GET_FILE_ENCODING_UNICODE()
    {
        string path = @$"./TestData/{nameof(GET_FILE_ENCODING_UNICODE)}.txt";
    ...
    [Fact]
    public static void GET_FILE_ENCODING_UTF32()
    {
        string path = @$"./TestData/{nameof(GET_FILE_ENCODING_UTF32)}.txt";
    ...
    [Fact]
    public static void GET_FILE_ENCODING_ASCII()
    {
        string path = @$"./TestData/{nameof(GET_FILE_ENCODING_ASCII)}.txt";
